...
class HashyooEntrust
{
     ...
     */
    public function permission_list($arr_option = []){
        $result = EntrustPermissionsService::all_get($arr_option);
        return $result;
    }
     ...
     * @author wumengmeng <wu_mengmeng@foxmail.com>
     */
    public function permission_normal_list($arr_option = []){
        $result = EntrustPermissionsService::normal_get($arr_option);
        return $result;
    }
     ...
     * @author wumengmeng <wu_mengmeng@foxmail.com>
     */
    public function role_list($arr_option = []){
        $result = EntrustRolesService::all_get($arr_option);
        return $result;
    }
     ...
     * @author wumengmeng <wu_mengmeng@foxmail.com>
     */
    public function role_normal_list($arr_option = []){
        $result = EntrustRolesService::normal_get($arr_option);
        return $result;
    }
